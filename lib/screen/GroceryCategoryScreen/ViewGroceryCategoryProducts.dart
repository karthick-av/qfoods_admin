...
class ViewCategoryProductsScreen extends StatefulWidget {
  ...
  const ViewCategoryProductsScreen({super.key, required this.category});
...
void initState(){
  ...
  WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
   ...
   final productsprovider = Provider.of<CategoryProductsProvider>(context, listen: false);
...
try{
       String url = "${ApiServices.get_grocery_categories}/products/${widget.category?.categoryId}?page=${current_page}&per_page=${per_page}&${filter}";
     print(url);
...
Future<void> AdditemHandler(List<SearchProductModel> product) async{
     try{
       String url = "${ApiServices.get_grocery_categories}/products/";
     List<dynamic> data = [];
     product?.forEach((e) {
      data.add({
...
Future<void> deleteitemHandler(SearchProductModel product) async{
  final productsProvider = Provider.of<CategoryProductsProvider>(context, listen: false);
     try{
       String url = "${ApiServices.get_grocery_categories}/products/${widget?.category?.categoryId}/${product?.groceryId}";
   print(url);
 ...
 final productsProvider = Provider.of<CategoryProductsProvider>(context, listen: true);
