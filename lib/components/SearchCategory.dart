...
void SearchCategory(BuildContext context, Future<void> Function(List<CategoryModel> categories) additemHandler){
  double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
bool loading = false;
final SelectedProvider = Provider.of<SearchCategoryProvider>(context, listen: false);
...
try{
       String url = "${ApiServices.search_categories}${text}";
     print(url);
            ...
            return Dialog(
              ...
              child: StatefulBuilder(
                builder: (context, myState) {
                  final SelectedProvider = Provider.of<SearchCategoryProvider>(context, listen: true);
